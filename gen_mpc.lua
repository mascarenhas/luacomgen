  ...
  methods = {
    {
      ...
      parameters = {
        ...
        { type = types.variant, attributes = { out = true }, name = "Kph" },
        { type = types.variant, attributes = { out = true }, name = "SPh" },
        { type = types.variant, attributes = { out = true }, name = "exitFlag" },
        { type = types.variant, attributes = { out = true }, name = "u0" },
        { type = types.variant, attributes = { out = true }, name = "xk_1" },
        { type = types.variant, attributes = { out = true }, name = "Fo" },
        { type = types.variant, attributes = { out = true }, name = "x0" },
        { type = types.variant, attributes = { out = true }, name = "ParametrosForaDaFaixa" },
        { type = types.variant, attributes = { out = true }, name = "h_passado" },
